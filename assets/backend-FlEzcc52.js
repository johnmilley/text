var ht=Object.defineProperty;var ut=(t,e,n)=>e in t?ht(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var g=(t,e,n)=>ut(t,typeof e!="symbol"?e+"":e,n);import{rpc as E,DropboxError as Q,hasTag as X,upload as F,download as O,getMetadata as pt,mtimeOf as T,getMetadataOrNull as ve,listFolderAll as ft,listFolderContinue as dt,listFolderFull as gt}from"./client-CUGrZ8eF.js";import{x as pr}from"./index-DgWeHsJw.js";const kt="text-dropbox",D="files",Z="kv";let Re=null;function de(){return Re??(Re=new Promise(t=>{try{const e=indexedDB.open(kt,1);e.onupgradeneeded=()=>{e.result.createObjectStore(D,{keyPath:"pathLower"}),e.result.createObjectStore(Z)},e.onsuccess=()=>t(e.result),e.onerror=()=>t(null)}catch{t(null)}})),Re}async function W(t,e,n){const r=await de();r&&await new Promise(s=>{try{const i=r.transaction(t,e);n(i.objectStore(t)),i.oncomplete=()=>s(),i.onerror=()=>s(),i.onabort=()=>s()}catch{s()}})}async function bt(){const t=await de();return t?new Promise(e=>{try{const n=t.transaction(D,"readonly").objectStore(D).getAll();n.onsuccess=()=>e(n.result),n.onerror=()=>e([])}catch{e([])}}):[]}const mt=t=>W(D,"readwrite",e=>e.put(t)),xt=t=>W(D,"readwrite",e=>e.delete(t)),Je=t=>W(D,"readwrite",e=>{e.delete(t),e.delete(IDBKeyRange.bound(`${t}/`,`${t}/￿`))});async function wt(t){const e=await de();return e?new Promise(n=>{try{const r=e.transaction(Z,"readonly").objectStore(Z).get(`cursor:${t}`);r.onsuccess=()=>n(r.result??null),r.onerror=()=>n(null)}catch{n(null)}}):null}const Te=(t,e)=>W(Z,"readwrite",n=>n.put(e,`cursor:${t}`)),yt=t=>W(Z,"readwrite",e=>e.delete(`cursor:${t}`)),Ve="text.config",_t=()=>({quick_switch:"ctrl+p",new_note:"ctrl+n",daily_note:"ctrl+shift+d",open_folder:"ctrl+o",switch_folder:"ctrl+shift+o",search:"ctrl+shift+f",backlinks:"ctrl+shift+b",theme:"ctrl+shift+t",editor_font:"ctrl+shift+e",share:"ctrl+shift+s",config:"ctrl+,",shortcuts:"ctrl+/",toggle_sidebar:"ctrl+\\",new_tab:"ctrl+t",close_tab:"ctrl+w",next_tab:"ctrl+tab",prev_tab:"ctrl+shift+tab",new_window:"ctrl+shift+n",split:"ctrl+shift+\\",preview:"ctrl+shift+m",focus_tree:"ctrl+e",calendar:"ctrl+shift+c",zen:"alt+z"}),St=()=>({theme:"text-dark",font_size:15,ui_font_size:13,editor_font:"",editor_margin:24,line_width:80,line_numbers:!1,highlight_line:!0,vim_mode:!1,single_line_breaks:!1,root:null,recent_roots:[],pinned_roots:[],daily_dir:"daily",image_dir:"",sidebar_width:240,sidebar_right:!1,zen_sidebar:!1,zen_typewriter:!0,typewriter_anchor:"top",spellcheck:!1,preview_replaces_editor:!1,toolbar_capture:!0,toolbar_calendar:!0,toolbar_preview:!0,keys:_t()});function $t(){const t=St();try{const e=localStorage.getItem(Ve);if(!e)return t;const n=JSON.parse(e);return{...t,...n,keys:{...t.keys,...n.keys??{}}}}catch{return t}}function vt(t){localStorage.setItem(Ve,JSON.stringify(t))}const Rt=new RegExp("(?:^|[\\s([{])#([\\p{L}\\p{N}/_-]*\\p{L}[\\p{L}\\p{N}/_-]*)","gu"),Tt=/^\s*(?:[-*+]|\d+[.)])\s+\[( |x|X)\]\s+(.*)$/;function Ct(t){var o;const e={},n=[],r=[],s=t.split(`
`);let i=0;if(((o=s[0])==null?void 0:o.trim())==="---")for(i=1;i<s.length;i++){const a=s[i].trim();if(a==="---"||a==="..."){i++;break}const h=a.indexOf(":");if(h<0)continue;const c=a.slice(0,h).trim().toLowerCase(),u=a.slice(h+1).trim().replace(/^["']|["']$/g,"");if(!(!c||c.includes(" "))){if(c==="tags")for(const f of u.split(/[, ]/)){const m=f.trim().replace(/^#/,"").toLowerCase();m&&!n.includes(m)&&n.push(m)}e[c]=u}}let l=null;for(;i<s.length;i++){const a=s[i],h=a.trimStart();if(l){h.startsWith(l)&&(l=null);continue}if(h.startsWith("```")||h.startsWith("~~~")){l=h.slice(0,3);continue}for(const u of a.matchAll(Rt)){const f=u[1].toLowerCase();n.includes(f)||n.push(f)}const c=Tt.exec(a);c&&r.push({text:c[2].trim(),done:c[1]!==" ",line:i+1})}return{fields:e,tags:n,tasks:r}}const zt=t=>/\.(md|markdown|mdown)$/i.test(t);function ge(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var M=ge();function Ge(t){M=t}var A={exec:()=>null};function P(t){let e=[];return n=>{let r=Math.max(0,Math.min(3,n-1)),s=e[r];return s||(s=t(r),e[r]=s),s}}function d(t,e=""){let n=typeof t=="string"?t:t.source,r={replace:(s,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(w.caret,"$1"),n=n.replace(s,l),r},getRegex:()=>new RegExp(n,e)};return r}var Lt=((t="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+t)}catch{return!1}})(),w={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:P(t=>new RegExp(`^ {0,${t}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:P(t=>new RegExp(`^ {0,${t}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:P(t=>new RegExp(`^ {0,${t}}(?:\`\`\`|~~~)`)),headingBeginRegex:P(t=>new RegExp(`^ {0,${t}}#`)),htmlBeginRegex:P(t=>new RegExp(`^ {0,${t}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:P(t=>new RegExp(`^ {0,${t}}>`))},At=/^(?:[ \t]*(?:\n|$))+/,Bt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Mt=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,J=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Et=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ke=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,He=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Qe=d(He).replace(/bull/g,ke).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Pt=d(He).replace(/bull/g,ke).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),be=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Dt=/^[^\n]+/,me=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,It=d(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",me).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),qt=d(/^(bull)([ \t][^\n]*?)?(?:\n|$)/).replace(/bull/g,ke).getRegex(),ne="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",xe=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,jt=d("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",xe).replace("tag",ne).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Xe=d(be).replace("hr",J).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ne).getRegex(),Ft=d(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Xe).getRegex(),we={blockquote:Ft,code:Bt,def:It,fences:Mt,heading:Et,hr:J,html:jt,lheading:Qe,list:qt,newline:At,paragraph:Xe,table:A,text:Dt},Ce=d("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",J).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ne).getRegex(),Nt={...we,lheading:Pt,table:Ce,paragraph:d(be).replace("hr",J).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ce).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ne).getRegex()},Ot={...we,html:d(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",xe).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:A,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:d(be).replace("hr",J).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Qe).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Zt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Wt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ue=/^( {2,}|\\)\n(?!\s*$)/,Jt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,I=/[\p{P}\p{S}]/u,re=/[\s\p{P}\p{S}]/u,ye=/[^\s\p{P}\p{S}]/u,Vt=d(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,re).getRegex(),Ke=/(?!~)[\p{P}\p{S}]/u,Gt=/(?!~)[\s\p{P}\p{S}]/u,Ht=/(?:[^\s\p{P}\p{S}]|~)/u,Qt=d(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Lt?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ye=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Xt=d(Ye,"u").replace(/punct/g,I).getRegex(),Ut=d(Ye,"u").replace(/punct/g,Ke).getRegex(),et="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Kt=d(et,"gu").replace(/notPunctSpace/g,ye).replace(/punctSpace/g,re).replace(/punct/g,I).getRegex(),Yt=d(et,"gu").replace(/notPunctSpace/g,Ht).replace(/punctSpace/g,Gt).replace(/punct/g,Ke).getRegex(),en=d("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ye).replace(/punctSpace/g,re).replace(/punct/g,I).getRegex(),tn=d(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,I).getRegex(),nn="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",rn=d(nn,"gu").replace(/notPunctSpace/g,ye).replace(/punctSpace/g,re).replace(/punct/g,I).getRegex(),sn=d(/\\(punct)/,"gu").replace(/punct/g,I).getRegex(),an=d(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),on=d(xe).replace("(?:-->|$)","-->").getRegex(),ln=d("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",on).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),U=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,cn=d(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",U).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),tt=d(/^!?\[(label)\]\[(ref)\]/).replace("label",U).replace("ref",me).getRegex(),nt=d(/^!?\[(ref)\](?:\[\])?/).replace("ref",me).getRegex(),hn=d("reflink|nolink(?!\\()","g").replace("reflink",tt).replace("nolink",nt).getRegex(),ze=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,_e={_backpedal:A,anyPunctuation:sn,autolink:an,blockSkip:Qt,br:Ue,code:Wt,del:A,delLDelim:A,delRDelim:A,emStrongLDelim:Xt,emStrongRDelimAst:Kt,emStrongRDelimUnd:en,escape:Zt,link:cn,nolink:nt,punctuation:Vt,reflink:tt,reflinkSearch:hn,tag:ln,text:Jt,url:A},un={..._e,link:d(/^!?\[(label)\]\((.*?)\)/).replace("label",U).getRegex(),reflink:d(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",U).getRegex()},ce={..._e,emStrongRDelimAst:Yt,emStrongLDelim:Ut,delLDelim:tn,delRDelim:rn,url:d(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",ze).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:d(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",ze).getRegex()},pn={...ce,br:d(Ue).replace("{2,}","*").getRegex(),text:d(ce.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},G={normal:we,gfm:Nt,pedantic:Ot},j={normal:_e,gfm:ce,breaks:pn,pedantic:un},fn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Le=t=>fn[t];function v(t,e){if(e){if(w.escapeTest.test(t))return t.replace(w.escapeReplace,Le)}else if(w.escapeTestNoEncode.test(t))return t.replace(w.escapeReplaceNoEncode,Le);return t}function Ae(t){try{t=encodeURI(t).replace(w.percentDecode,"%")}catch{return null}return t}function Be(t,e){var i;let n=t.replace(w.findPipe,(l,o,a)=>{let h=!1,c=o;for(;--c>=0&&a[c]==="\\";)h=!h;return h?"|":" |"}),r=n.split(w.splitPipe),s=0;if(r[0].trim()||r.shift(),r.length>0&&!((i=r.at(-1))!=null&&i.trim())&&r.pop(),e)if(r.length>e)r.splice(e);else for(;r.length<e;)r.push("");for(;s<r.length;s++)r[s]=r[s].trim().replace(w.slashPipe,"|");return r}function z(t,e,n){let r=t.length;if(r===0)return"";let s=0;for(;s<r&&t.charAt(r-s-1)===e;)s++;return t.slice(0,r-s)}function Me(t){let e=t.split(`
`),n=e.length-1;for(;n>=0&&w.blankLine.test(e[n]);)n--;return e.length-n<=2?t:e.slice(0,n+1).join(`
`)}function dn(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let r=0;r<t.length;r++)if(t[r]==="\\")r++;else if(t[r]===e[0])n++;else if(t[r]===e[1]&&(n--,n<0))return r;return n>0?-2:-1}function gn(t,e=0){let n=e,r="";for(let s of t)if(s==="	"){let i=4-n%4;r+=" ".repeat(i),n+=i}else r+=s,n++;return r}function Ee(t,e,n,r,s){let i=e.href,l=e.title||null,o=t[1].replace(s.other.outputLinkReplace,"$1");r.state.inLink=!0;let a={type:t[0].charAt(0)==="!"?"image":"link",raw:n,href:i,title:l,text:o,tokens:r.inlineTokens(o)};return r.state.inLink=!1,a}function kn(t,e,n){let r=t.match(n.other.indentCodeCompensation);if(r===null)return e;let s=r[1];return e.split(`
`).map(i=>{let l=i.match(n.other.beginningSpace);if(l===null)return i;let[o]=l;return o.length>=s.length?i.slice(s.length):i}).join(`
`)}var K=class{constructor(t){g(this,"options");g(this,"rules");g(this,"lexer");this.options=t||M}space(t){let e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){let e=this.rules.block.code.exec(t);if(e){let n=this.options.pedantic?e[0]:Me(e[0]),r=n.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:n,codeBlockStyle:"indented",text:r}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let n=e[0],r=kn(n,e[3]||"",this.rules);return{type:"code",raw:n,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:r}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let n=e[2].trim();if(this.rules.other.endingHash.test(n)){let r=z(n,"#");(this.options.pedantic||!r||this.rules.other.endingSpaceChar.test(r))&&(n=r.trim())}return{type:"heading",raw:z(e[0],`
...
`,t=t.substring(f.length+1),a=!0),!a){let y=this.rules.other.nextBulletRegex(p),x=this.rules.other.hrRegex(p),V=this.rules.other.fencesBeginRegex(p),L=this.rules.other.headingBeginRegex(p),ie=this.rules.other.htmlBeginRegex(p),ct=this.rules.other.blockquoteBeginRegex(p);for(;t;){let ae=t.split(`
`,1)[0],q;if(f=ae,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),q=f):q=f.replace(this.rules.other.tabCharGlobal,"    "),V.test(f)||L.test(f)||ie.test(f)||ct.test(f)||y.test(f)||x.test(f))break;if(q.search(this.rules.other.nonSpaceChar)>=p||!f.trim())c+=`
`+q.slice(p);else{if(m||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||V.test(u)||L.test(u)||x.test(u))break;c+=`
`+f}m=!f.trim(),h+=ae+`
...
`)?"":`
`)+a.raw,c.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=c.text):n.push(a);continue}if(e){this.infiniteLoopError(e.charCodeAt(0));break}}return this.state.top=!0,n}inline(e,n=[]){return this.inlineQueue.push({src:e,tokens:n}),n}inlineTokens(e,n=[]){var h,c,u,f,m;this.tokenizer.lexer=this;let r=e,s=null;if(this.tokens.links){let p=Object.keys(this.tokens.links);if(p.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(r))!==null;)p.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(r=r.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+r.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(r))!==null;)r=r.slice(0,s.index)+"++"+r.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(r))!==null;)i=s[2]?s[2].length:0,r=r.slice(0,s.index+i)+"["+"a".repeat(s[0].length-i-2)+"]"+r.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);r=((c=(h=this.options.hooks)==null?void 0:h.emStrongMask)==null?void 0:c.call({lexer:this},r))??r;let l=!1,o="",a=1/0;for(;e;){if(e.length<a)a=e.length;else{this.infiniteLoopError(e.charCodeAt(0));break}l||(o=""),l=!1;let p;if((f=(u=this.options.extensions)==null?void 0:u.inline)!=null&&f.some(x=>(p=x.call({lexer:this},e,n))?(e=e.substring(p.raw.length),n.push(p),!0):!1))continue;if(p=this.tokenizer.escape(e)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.tag(e)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.link(e)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(p.raw.length);let x=n.at(-1);p.type==="text"&&(x==null?void 0:x.type)==="text"?(x.raw+=p.raw,x.text+=p.text):n.push(p);continue}if(p=this.tokenizer.emStrong(e,r,o)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.codespan(e)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.br(e)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.del(e,r,o)){e=e.substring(p.raw.length),n.push(p);continue}if(p=this.tokenizer.autolink(e)){e=e.substring(p.raw.length),n.push(p);continue}if(!this.state.inLink&&(p=this.tokenizer.url(e))){e=e.substring(p.raw.length),n.push(p);continue}let y=e;if((m=this.options.extensions)!=null&&m.startInline){let x=1/0,V=e.slice(1),L;this.options.extensions.startInline.forEach(ie=>{L=ie.call({lexer:this},V),typeof L=="number"&&L>=0&&(x=Math.min(x,L))}),x<1/0&&x>=0&&(y=e.substring(0,x+1))}if(p=this.tokenizer.inlineText(y)){e=e.substring(p.raw.length),p.raw.slice(-1)!=="_"&&(o=p.raw.slice(-1)),l=!0;let x=n.at(-1);(x==null?void 0:x.type)==="text"?(x.raw+=p.raw,x.text+=p.text):n.push(p);continue}if(e){this.infiniteLoopError(e.charCodeAt(0));break}}return n}infiniteLoopError(e){let n="Infinite loop on byte: "+e;if(this.options.silent)console.error(n);else throw new Error(n)}},Y=class{constructor(t){g(this,"options");g(this,"parser");this.options=t||M}space(t){return""}code({text:t,lang:e,escaped:n}){var i;let r=(i=(e||"").match(w.notSpaceStart))==null?void 0:i[0],s=t.replace(w.endingNewline,"")+`
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Rn=`# text — Dracula: the high-contrast purple/pink dark classic (draculatheme.com).
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Tn=`# text — Emotion Side B Dark: crisp charcoal page, the album's bright blue and
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Cn=`# text — Emotion Side B: crisp white page, the album's bright blue and hot
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,zn=`# text — GitHub Light: stark white and gray, straight off the platform.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Ln=`# text — Gruvbox Light: the warm, retro counterpart to Gruvbox.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,An=`# text — Gruvbox: warm retro-groove dark (github.com/morhetz/gruvbox).
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Bn=`# text — iA Writer Dark: the signature minimalist look, inverted. Near-black
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Mn=`# text — iA Writer: clean minimalist white with the signature blue accent.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,En=`# text — Monokai Calm: monokai's voice, desaturated to easy-evening levels.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Pn=`# text — Nord Light: the Snow Storm palette, frost accents on cool white.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Dn=`# text — Nord: the arctic, muted blue palette (nordtheme.com).
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,In=`# text — Solarized Dark: Ethan Schoonover's precision palette (ethanschoonover.com/solarized).
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,qn=`# text — Solarized Light: Ethan Schoonover's classic low-contrast prose palette.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Fn=`# text — Text Light: paper-white counterpart to Text Dark.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Nn=`# text — Tokyo Day: the bright daytime variant of Tokyo Night.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,On=`# text — Tokyo Night: neon dusk-to-night blues and purples.
# See text-dark.toml for the token reference.
...
editor = "ui-monospace, 'JetBrains Mono', 'Fira Code', 'DejaVu Sans Mono', monospace"
ui = "system-ui, sans-serif"
`,Zn=`/* Emotion Side B Dark — hot pink on the active file row against blue chrome. */
.tree-row.current {
...
`,Wn=`/* Emotion Side B — put the hot pink on the active file row so it reads
...
`,Jn=Object.assign({"../../src-tauri/themes/catppuccin-latte.toml":$n,"../../src-tauri/themes/catppuccin-mocha.toml":vn,"../../src-tauri/themes/dracula.toml":Rn,"../../src-tauri/themes/emotion-side-b-dark.toml":Tn,"../../src-tauri/themes/emotion-side-b.toml":Cn,"../../src-tauri/themes/github-light.toml":zn,"../../src-tauri/themes/gruvbox-light.toml":Ln,"../../src-tauri/themes/gruvbox.toml":An,"../../src-tauri/themes/ia-writer-dark.toml":Bn,"../../src-tauri/themes/ia-writer.toml":Mn,"../../src-tauri/themes/monokai-calm.toml":En,"../../src-tauri/themes/nord-light.toml":Pn,"../../src-tauri/themes/nord.toml":Dn,"../../src-tauri/themes/solarized-dark.toml":In,"../../src-tauri/themes/solarized-light.toml":qn,"../../src-tauri/themes/text-dark.toml":jn,"../../src-tauri/themes/text-light.toml":Fn,"../../src-tauri/themes/tokyo-day.toml":Nn,"../../src-tauri/themes/tokyo-night.toml":On}),Vn=Object.assign({"../../src-tauri/themes/emotion-side-b-dark.css":Zn,"../../src-tauri/themes/emotion-side-b.css":Wn}),Pe=t=>(t.split("/").pop()??t).replace(/\.[^.]*$/,"");function Gn(t){let e="",n=!1;const r={colors:{},fonts:{}};let s=null;for(const i of t.split(`
`)){const l=i.trim();if(!l||l.startsWith("#"))continue;const o=/^\[([A-Za-z0-9_-]+)\]$/.exec(l);if(o){s=r[o[1]]??(r[o[1]]={});continue}const a=/^([A-Za-z0-9_-]+)\s*=\s*(.+)$/.exec(l);if(!a)continue;const h=a[1];let c=a[2].trim(),u;const f=/^"((?:[^"\\]|\\.)*)"|^'([^']*)'/.exec(c);f?u=f[1]!==void 0?f[1].replace(/\\(.)/g,"$1"):f[2]:u=c.split("#")[0].trim(),s?s[h]=u:h==="name"?e=u:h==="dark"&&(n=u==="true")}return{name:e,dark:n,colors:r.colors,fonts:r.fonts}}let oe=null;function Hn(){if(oe)return oe;const t=new Map(Object.entries(Vn).map(([n,r])=>[Pe(n),r])),e=[];for(const[n,r]of Object.entries(Jn)){const s=Pe(n);try{const i=Gn(r);e.push({id:s,name:i.name||s,dark:i.dark,colors:i.colors,fonts:i.fonts,css:t.get(s)??null})}catch(i){console.error(`theme ${s}:`,i)}}return e.sort((n,r)=>n.name.localeCompare(r.name)),oe=e,e}const Qn=4*1024*1024,Xn=2*1024*1024,De=500,Un=new Set(["md","markdown","mdown","txt","text","json","yaml","yml","toml","ini","cfg","conf","csv","tsv","log","tex","bib","org","rst","adoc","html","htm","css","js","ts","jsx","tsx","py","rs","sh","bash","zsh","fish","c","h","cpp","hpp","go","rb","lua","sql","xml","svg","env","gitignore","fountain"]),Kn=new Set(["png","jpg","jpeg","gif","webp","bmp","ico","avif","tiff","tif","mp3","wav","ogg","oga","m4a","flac","opus","aac","weba","mp4","m4v","webm","mov","mkv","ogv","pdf"]),ot=t=>{const e=t.lastIndexOf(".");return e>0?t.slice(e+1).toLowerCase():null},$e=t=>{const e=ot(t);return e===null||Un.has(e)},Yn=t=>$e(t)||Kn.has(ot(t)??""),b=t=>{const e=t.trim().replace(/\/+$/,"");return e===""||e==="/"?"":e.startsWith("/")?e:`/${e}`},Ie=(t,e)=>`${b(t)}/${e}`,qe=t=>t.slice(t.lastIndexOf("/")+1),ee=t=>t.slice(0,t.lastIndexOf("/")),te=(t,e)=>e.slice(b(t).length).replace(/^\//,""),pe=t=>t.split("/").some(e=>e.startsWith(".")),se=new Map,C=new Map;function R(t,e){const n=T(t);if(se.set(t.path_lower,{rev:t.rev,mtime:n}),e!==void 0&&$e(t.name)){const r={rev:t.rev,text:e,mtime:n,path:t.path_display,size:t.size};C.set(t.path_lower,r),mt({pathLower:t.path_lower,...r})}}function je(t){const e=`${t}/`;for(const n of[se,C])for(const r of n.keys())(r===t||r.startsWith(e))&&n.delete(r);Je(t)}const fe=t=>t!==null&&t[".tag"]!=="folder",Fe=(t,e)=>e[".tag"]==="file"&&$e(e.name)&&e.size<=Qn&&!pe(te(t,e.path_display));let er=null;const tr=()=>er??(er=bt().then(t=>{for(const e of t)C.has(e.pathLower)||C.set(e.pathLower,{rev:e.rev,text:e.text,mtime:e.mtime,path:e.path,size:e.size})}));async function Ne(t){const e=t.filter(s=>{var i;return((i=C.get(s.path_lower))==null?void 0:i.rev)!==s.rev});let n=0;const r=async()=>{for(;n<e.length;){const s=e[n++],{resp:i,meta:l}=await O(s.path_lower);R(l,await i.text())}};await Promise.all(Array.from({length:Math.min(6,e.length)},r))}async function le(t){const e=b(t);await tr();const n=await wt(e.toLowerCase());let r=!1;if(n)try{const l=await dt(n);for(const o of l.entries)o[".tag"]==="deleted"&&(C.delete(o.path_lower),se.delete(o.path_lower),Je(o.path_lower));await Ne(l.entries.filter(o=>Fe(e,o))),await Te(e.toLowerCase(),l.cursor),r=!0}catch{await yt(e.toLowerCase())}if(!r){const{entries:l,cursor:o}=await gt(e,!0),a=l.filter(u=>Fe(e,u)),h=new Set(a.map(u=>u.path_lower)),c=`${e.toLowerCase()}/`;for(const u of C.keys())u.startsWith(c)&&!h.has(u)&&(C.delete(u),xt(u));await Ne(a),await Te(e.toLowerCase(),o)}const s=`${e.toLowerCase()}/`,i=[];for(const[l,o]of C)l.startsWith(s)&&i.push(o);return i}async function nr(t,e,n){const r=b(t);let s;const i=se.get(r.toLowerCase());if(n===null)s="overwrite";else if(i&&i.mtime===n)s={".tag":"update",update:i.rev};else{const l=await ve(r);if(!fe(l))s="add";else{if(T(l)!==n)return{mtime:T(l),conflict:!0};s={".tag":"update",update:l.rev}}}try{const l=await F(r,e,s);return R(l,e),{mtime:T(l),conflict:!1}}catch(l){if(l instanceof Q&&X(l.error,"conflict")){const o=await ve(r);return{mtime:fe(o)?T(o):0,conflict:!0}}throw l}}const lt=new Map,Oe=new Map;async function rr(t){const e=b(t),n={};for(const r of lt.get(e.toLowerCase())??[]){let s=Oe.get(r.path_lower);if(!s||s.rev!==r.rev){s={rev:r.rev,order:[]};try{const l=JSON.parse(await(await O(r.path_lower)).resp.text()).order;Array.isArray(l)&&(s.order=l.filter(o=>typeof o=="string"))}catch{}Oe.set(r.path_lower,s)}if(s.order.length){const i=ee(r.path_lower);n[i===e.toLowerCase()?e:ee(r.path_display)]=s.order}}return n}async function sr(t){const e=b(t),n=await ft(e,!0);lt.set(e.toLowerCase(),n.filter(o=>o[".tag"]==="file"&&o.name===".corkboard"&&!pe(te(e,ee(o.path_display)))));const r=new Map,s={name:"",path:e,is_dir:!0,mtime:0,children:[]};r.set(e.toLowerCase(),s);const i=n.filter(o=>o.path_lower!==e.toLowerCase()&&!pe(te(e,o.path_display)));for(const o of i)o[".tag"]==="folder"&&r.set(o.path_lower,{name:o.name,path:o.path_display,is_dir:!0,mtime:0,children:[]});for(const o of i){const a=r.get(ee(o.path_lower)||e.toLowerCase());a&&(o[".tag"]==="folder"?a.children.push(r.get(o.path_lower)):Yn(o.name)&&(R(o),a.children.push({name:o.name,path:o.path_display,is_dir:!1,mtime:T(o),children:null})))}const l=o=>{const a=c=>c.name.toLowerCase(),h=[...o.filter(c=>c.is_dir).sort((c,u)=>a(c).localeCompare(a(u))),...o.filter(c=>!c.is_dir).sort((c,u)=>a(c).localeCompare(a(u)))];for(const c of h)c.children&&(c.children=l(c.children));return h};return l(s.children)}const Ze=t=>{const e=new Uint8Array(t);let n="";const r=32768;for(let s=0;s<e.length;s+=r)n+=String.fromCharCode(...e.subarray(s,s+r));return btoa(n)},We=t=>{const e=atob(t),n=new Uint8Array(e.length);for(let r=0;r<e.length;r++)n[r]=e.charCodeAt(r);return n},ir=(t,e,n)=>n?t.toLowerCase().indexOf(e):t.indexOf(e),cr={listTree:sr,folderOrders:rr,writeFile:nr,readFile:async t=>{const{resp:e,meta:n}=await O(b(t)),r=await e.text();return R(n,r),{content:r,mtime:T(n)}},readImage:async t=>{const{resp:e,meta:n}=await O(b(t));return R(n),{base64:Ze(await e.arrayBuffer()),mtime:T(n)}},statMtime:async t=>{const e=await pt(b(t));if(!fe(e))throw new Error(`${t} is a folder`);return T(e)},createFile:async t=>{try{R(await F(b(t),"","add"),"")}catch(e){throw e instanceof Q&&X(e.error,"conflict")?new Error(`${t} already exists`):e}},createDir:async t=>{try{await E("files/create_folder_v2",{path:b(t),autorename:!1})}catch(e){if(e instanceof Q&&X(e.error,"conflict"))return;throw e}},renamePath:async(t,e)=>{await E("files/move_v2",{from_path:b(t),to_path:b(e),autorename:!1}),je(b(t).toLowerCase())},copyPath:async(t,e)=>(await E("files/copy_v2",{from_path:b(t),to_path:Ie(e,qe(b(t))),autorename:!0})).metadata.path_display,overwriteBase64:async(t,e)=>{R(await F(b(t),We(e),"overwrite"))},importFile:()=>{throw new Error("importFile is desktop-only")},writeBase64:async(t,e,n)=>{const r=await F(Ie(t,e),We(n),"add",!0);return R(r),r.path_display},trashPath:async t=>{await E("files/delete_v2",{path:b(t)}),je(b(t).toLowerCase())},readBase64:async t=>{const{resp:e,meta:n}=await O(b(t));return R(n),Ze(await e.arrayBuffer())},writeTextFile:async(t,e)=>{R(await F(b(t),e,"overwrite"),e)},copyFile:async(t,e)=>{try{await E("files/delete_v2",{path:b(e)})}catch(n){if(!(n instanceof Q&&X(n.error,"not_found")))throw n}await E("files/copy_v2",{from_path:b(t),to_path:b(e),autorename:!1})},searchText:async(t,e)=>{if(!e.trim())return[];const n=!new RegExp("\\p{Lu}","u").test(e),r=n?e.toLowerCase():e,s=[];for(const i of await le(t)){const l=i.text.split(`
`);for(let o=0;o<l.length;o++){const a=ir(l[o],r,n);if(!(a<0)&&(s.push({path:i.path,line:o+1,text:l[o].slice(0,400),start:a,end:Math.min(a+e.length,400)}),s.length>=De))return s}}return s},findBacklinks:async(t,e)=>{if(!e.trim())return[];const n=e.trim().replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),r=new RegExp(`\\[\\[${n}\\s*([|#][^\\]]*)?\\]\\]`,"i"),s=[];for(const i of await le(t)){const l=i.text.split(`
`);for(let o=0;o<l.length;o++){const a=r.exec(l[o]);if(a&&(s.push({path:i.path,line:o+1,text:l[o].slice(0,400),start:a.index,end:Math.min(a.index+a[0].length,400)}),s.length>=De))return s}}return s},collectNotes:async t=>{const e=[];for(const n of await le(t)){const r=qe(n.path);if(!zt(r)||n.size>Xn)continue;const{fields:s,tags:i,tasks:l}=Ct(n.text);e.push({path:n.path,rel:te(t,n.path),name:r.replace(/\.[^.]*$/,""),mtime:n.mtime,tags:i,fields:s,tasks:l})}return e},openWindow:async(t,e)=>{const n=new URL(location.origin+location.pathname);t&&n.searchParams.set("root",t),e&&n.searchParams.set("file",e),window.open(n.toString(),"_blank")},windowInitParams:async()=>{const t=new URLSearchParams(location.search),e=t.get("root"),n=t.get("file");return e||n?{root:e,file:n}:null},renderPreview:async t=>Sn(t),listThemes:async()=>Hn(),themesDirPath:async()=>"",loadConfig:async()=>$t(),saveConfig:async t=>vt(t),watchRoot:async()=>{}};export{pr as auth,cr as dropboxBackend,lr as setSingleLineBreaks};
